...
Vous devez obligatoirement répondre à l'aide de la syntaxe PlantUML. Vous pouvez utiliser un éditeur en ligne comme [PlantText](https://www.planttext.com/) pour dessiner votre diagramme de classes.
Ou bien, si vous ne l'avez pas déjà fait, vous pouvez installer l'extension PlantUML pour VS Code. (Voir Tuto)
