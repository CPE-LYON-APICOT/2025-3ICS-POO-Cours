...
> A partir de maintenant, vous devriez écrire des tests unitaires pour chaque nouvelle fonctionnalité que vous ajoutez à votre programme. Cela vous permettra de détecter rapidement les erreurs et de garantir que votre code fonctionne correctement.
...
### Etape 10 : Niveau d'expérience et Points de vie
