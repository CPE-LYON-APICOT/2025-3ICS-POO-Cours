---
title: "TP2 : Projet MVC Swing Java"
produce:
    html: 
...
Modifiez votre classe `MainApp.java` pour utiliser Spring Context :
...
```
> Pensez à remplacer `cpe.apicot.snake` par le package de votre projet.
...
Modifiez la classe `MainController` pour utiliser `GreetingService` :
...
public class MovementService {
    ...
    protected MovementService(GameStateService stateService) {
        this.stateService = stateService;
